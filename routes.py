...
def setup_routes(app):
    ...
    # Environment
    # Temperature
    temp_resource = cors.add(app.router.add_resource("/temperature/{login}", name='temperature'))
    cors.add(temp_resource.add_route("GET", sensors.TempsView))

    last_temp_resource = cors.add(app.router.add_resource("/temperature/last/{login}", name='last_temperature'))
    ...
    cors.add(user_temperature_log.add_route("POST", temperature.log_temperatures))
    cors.add(user_temperature_log.add_route("DELETE", temperature.delete_temperature_log))

    # Pressure
    press_resource = cors.add(app.router.add_resource("/pressure/{login}", name='pressure'))
    cors.add(press_resource.add_route("GET", sensors.PressView))

    last_press_resource = cors.add(app.router.add_resource("/pressure/last/{login}", name='last_pressure'))
    ...
    cors.add(user_pressure_log.add_route("POST", pressure.log_pressures))
    cors.add(user_pressure_log.add_route("DELETE", pressure.delete_pressure_log))

    # Humidity
    humid_resource = cors.add(app.router.add_resource("/humidity/{login}", name='humidity'))
    cors.add(humid_resource.add_route("GET", sensors.HumidView))

    last_humid_resource = cors.add(app.router.add_resource("/humidity/last/{login}", name='last_humidity'))
    ...
    cors.add(user_humidity_log.add_route("POST", humidity.log_humidities))
    cors.add(user_humidity_log.add_route("DELETE", humidity.delete_humidity_log))

    # Gas
    gas_resource = cors.add(app.router.add_resource("/gas/{login}", name='gas'))
    cors.add(gas_resource.add_route("GET", sensors.GasView))

    last_gas_resource = cors.add(app.router.add_resource("/gas/last/{login}", name='last_gas'))
    ...
    cors.add(user_gas_log.add_route("POST", gas.log_gases))
    cors.add(user_gas_log.add_route("DELETE", gas.delete_gas_log))

    # Light
    light_resource = cors.add(app.router.add_resource("/light/{login}", name='light'))
    cors.add(light_resource.add_route("GET", sensors.LightView))

    last_light_resource = cors.add(app.router.add_resource("/light/last/{login}", name='last_light'))
    ...
    cors.add(user_light_log.add_route("POST", light.log_light))
